...
export interface CanvasEditorProps {
  /** Called with the raw react-canvas-draw saveData JSON string when the person submits a non-empty drawing. */
  onSubmit: (saveData: string) => void;
  /** Bump this to any new value to clear the canvas from the parent (e.g. after "Draw another"). */
  resetSignal?: number;
}

export function CanvasEditor({ onSubmit, resetSignal }: CanvasEditorProps) {
  ...
  const handleSave = () => {
    ...
    if (isEmptySaveData(saveData)) return;
